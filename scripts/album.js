...
var nextSong = function() {
  ...
  // var currentSongEl = $('.song-item-number[data-song-number="' + currentlyPlayingSongNumber + '"]');
  // currentSongEl.text(currentlyPlayingSongNumber);
  //
  ...
  //   currentlyPlayingSongNumber = currentIndex + 2;
  // }
  //
